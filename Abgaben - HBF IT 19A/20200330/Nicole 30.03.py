...
wort1 = ["Hier","sind","nur","Worte","enthalten"]
wort2 = ["Hier","haben wir","einzelne","und","mehrere Worte","in der Liste"]
satz1 =["Das ist Satz eins.","Das ist Satz zwei","Und das ist Satz drei"]
...
CalculateStrings(wort1)
CalculateStrings(wort2)
CalculateStrings(satz1)